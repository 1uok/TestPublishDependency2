...
public class DoubleUtil implements Serializable {
    ...
    public static String setScale(Double value, int scale) {
        ...
        return String.valueOf(b.setScale(scale, BigDecimal.ROUND_HALF_UP).doubleValue());

    }

    public static String setScaleDown(Double value, int scale) {
        BigDecimal b = new BigDecimal(Double.toString(value));
        return String.valueOf(b.setScale(scale, BigDecimal.ROUND_DOWN).doubleValue());
    ...
    public static double sub3(Double value1, Double value2) {
        BigDecimal b1 = new BigDecimal(Double.toString(value1));
        BigDecimal b2 = new BigDecimal(Double.toString(value2));
    ...
    public static double mulLong(long value1, long value2) {
        BigDecimal b1 = new BigDecimal(Long.toString(value1));
        BigDecimal b2 = new BigDecimal(Long.toString(value2));
        return b1.multiply(b2).setScale(DEF_DIV_SCALE, BigDecimal.ROUND_HALF_UP).longValue();
